...
function AboutComponent({ data }: AboutProps) {
    return (
        <Section id="about" className="relative py-20 bg-[#fdfcfb] border-b border-[#0b0b10]/10">
            <div className="relative mx-auto max-w-[1500px] px-6 md:px-12 lg:px-24 space-y-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-5 space-y-12">
                        <div className="grid grid-cols-2 border border-[#0b0b10]/10">
                            {data.metrics.map((stat, i) => (
                                ...
                                >
                                    ...
                                    <p className="text-xs text-[#0b0b10]/65 leading-normal">
                                        {stat.desc}
                                    </p>
                                </motion.div>
                            ))}
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="bg-[#0b0b10] text-[#fdfcfb] p-8 border border-[#0b0b10]"
                        >
                            <div className="flex justify-between items-center mb-6 pb-4 border-b border-[#fdfcfb]/10">
                            ...
                            <ul className="space-y-0">
                                {data.blueprint.map((item, i) => (
                                    <li key={i} className="flex items-center gap-4 py-3 border-b border-[#fdfcfb]/5 last:border-0 text-sm text-[#fdfcfb]/80">
                ...
                {data.ourStoryTitle && (
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                            <p className="lg:col-span-5 text-base text-[#0b0b10]/70 leading-relaxed border-s border-[#5a1f2e] ps-6">
                                {data.ourStoryText}
                            </p>
                            <ol className="lg:col-span-7 divide-y divide-[#0b0b10]/10 border-y border-[#0b0b10]/10">
                                {data.ourStoryMilestones?.map((m, i) => (
                                    <li key={i} className="grid grid-cols-[6rem_1fr] gap-6 py-6">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-[#0b0b10]/65 leading-relaxed mt-1">{m.desc}</p>
                                        </div>
                                    </li>
                                ))}
                            </ol>
