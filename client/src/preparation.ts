...
export const PREPARATION_COPY: Record<Locale3, typeof en> = {
  en,
  ar: {
    title: "مساحة إعداد المشروع", intro: "جهّز الأسئلة والمعلومات الداعمة للنقاش الأول حول المشروع. قائمتك مذكرة عمل شخصية وليست تحققاً من المشروع.", select: "اختر مشروعاً منشوراً", choose: "اختر مشروعاً", save: "حفظ على هذا الجهاز", saved: "تم الحفظ على هذا الجهاز. لم تُرسل هذه المعلومات إلى التحالف.", failed: "تخزين الجهاز غير متاح. يمكنك تنزيل مذكرة العمل.", download: "تنزيل مذكرة الإعداد", reset: "مسح هذه القائمة", notes: "ملاحظات الإعداد الخاصة بك", noteHint: "لا تضع مستندات سرية أو بيانات شخصية تعريفية في هذه المذكرة.", questions: "قائمة الإعداد", status: "تقييمك", unknown: "لم يُقيّم", "in-progress": "قيد الإعداد", available: "متاح للنقاش", completed: "عناصر محددة كمتاحة", disclaimer: "ملاحظات إعداد مقدمة من المستخدم، وليست تقييماً فنياً أو التزاماً بالتمويل أو تصنيف جاهزية متحققاً منه.", publicInfo: "معلومات المشروع المنشورة", publishedNeeds: "فرص الشراكة المنشورة", next: "ناقش هذا المشروع", guide: "قراءة دليل التعاون",
