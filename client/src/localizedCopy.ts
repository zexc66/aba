...
export const LOCALIZED_COPY: Record<AppLocale, LocalizedCopy> = {
  en: {
    privacy: {
      ...
      sections: [
        { title: "1. Who we are", body: ["This website is operated by the African International Alliance for Business & Sustainable Development (AIABASD), with headquarters in London, United Kingdom, and a regional secretariat in Dakar, Senegal. For any privacy question, contact gs@aibasd.org."] },
        ...
        { title: "5. Your rights", body: ["Depending on your jurisdiction, including under the UK GDPR and the EU GDPR, you may have the right to access, correct, or delete the personal information we hold about you, and to withdraw consent at any time. To exercise these rights, email gs@aibasd.org."] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "6. Governing terms", body: ["Any engagement with AIABASD is ultimately governed by separately executed written agreements, which prevail over anything stated on this website. Questions: gs@aibasd.org."] },
      ],
    },
    consent: {
  ...
  ar: {
    privacy: {
      ...
      sections: [
        { title: "1. من نحن", body: ["يدير هذا الموقع التحالف الدولي الأفريقي للأعمال والتنمية المستدامة (AIABASD)، ومقره في لندن بالمملكة المتحدة، وأمانته الإقليمية في داكار بالسنغال. لأي سؤال يتعلق بالخصوصية، يرجى التواصل عبر gs@aibasd.org."] },
        ...
        { title: "5. حقوقك", body: ["بحسب نطاق اختصاصك، بما في ذلك بموجب UK GDPR وEU GDPR، قد يكون لك الحق في الوصول إلى معلوماتك الشخصية التي نحتفظ بها وتصحيحها أو حذفها، وسحب موافقتك في أي وقت. لممارسة هذه الحقوق، أرسل بريداً إلى gs@aibasd.org."] },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "6. الشروط الحاكمة", body: ["يخضع أي تعامل مع AIABASD في نهاية المطاف لاتفاقيات مكتوبة منفذة بشكل منفصل، وتعلو تلك الاتفاقيات على أي شيء مذكور في هذا الموقع. للاستفسارات: gs@aibasd.org."] },
      ],
    },
    consent: {
  ...
  fr: {
    ...
    terms: {
      ...
      sections: [
        ...
        { title: "6. Conditions applicables", body: ["Toute relation avec AIABASD est en définitive régie par des accords écrits distincts et signés, qui prévalent sur toute information publiée sur ce site. Questions : gs@aibasd.org."] },
      ],
    },
    consent: {
