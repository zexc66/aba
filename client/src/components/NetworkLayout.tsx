...
export const networkField = "w-full min-h-11 border border-[#0b0b10]/20 bg-white px-4 py-3 text-base text-[#0b0b10] focus:border-[#5a1f2e]";
export const networkButton = "inline-flex min-h-11 items-center justify-center gap-2 bg-[#5a1f2e] px-5 py-3 text-sm font-semibold text-[#fdfcfb] hover:bg-[#0b0b10] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#5a1f2e] disabled:opacity-50";
 ...
 */
export default function NetworkLayout({ title, description, path, children, noindex = false }: {
  title: string; description: string; path: string; children: ReactNode; noindex?: boolean;
}) {
