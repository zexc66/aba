...
export default function InvestorLogin() {
    ...
    return (
        <div className={`min-h-screen bg-[#0b0b10] text-[#fdfcfb] flex flex-col justify-between p-6 md:p-12 relative select-none ${isRTL ? 'font-arabic' : 'font-sans'}`}>
            <SEO title={`${t.vaultTitle} | AIABASD`} description={t.subtitle} lang={lang} />
