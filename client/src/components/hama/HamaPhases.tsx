            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 xl:gap-56 items-start relative z-10">
                <div className="lg:sticky lg:top-28">
                    ...
                    >
                        ...
                        <div className="pt-16 md:pt-24 flex flex-col sm:flex-row sm:items-center gap-6 sm:gap-12 text-[#fdfcfb]/35 font-sans">
                        ...
                        {t.list.map((phase, i) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="group bg-[#0b0b10] p-10 sm:p-16 xl:p-24 hover:bg-[#111119] transition-[background-color,transform] duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] relative overflow-hidden active:scale-[0.995]"
                                >
                                    ...
                                    <div className="flex items-center gap-12 mb-16 relative z-10 font-sans">
                                        <span className={`t-meta text-[9px] font-black tracking-[0.36em] px-6 py-2 border transition-[color,border-color,transform] duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isArchived ? "border-white/10 text-white/25" : "border-[#f2a007]/60 text-[#f2a007] motion-safe:animate-pulse"}`}>
                                            {phase.status}
                                        </span>
                                    </div>
                                    ...
                                    <p className="text-xl sm:text-2xl text-[#fdfcfb]/45 leading-tight font-institutional italic max-w-lg group-hover:text-[#fdfcfb]/80 transition-colors duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]">
                                        {phase.desc}
                                    </p>
                                </motion.div>
                            );
