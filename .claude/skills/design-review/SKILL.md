...
triggers:
  ...
  - fix design issues
---
<!-- Vendored from garrytan/gstack (design-review v2.0.0) into this project.
     All `gstack-*` bin/ and $B/$D harness calls are OPTIONAL — they fail soft.
     Without the gstack toolchain, run the phases with local tooling
     (browser automation + computed-style audits + atomic commits). -->
