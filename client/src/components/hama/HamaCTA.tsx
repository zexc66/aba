            ...
            <div className="max-w-6xl mx-auto relative z-10 overflow-x-clip">
                ...
                >
                    <div className="flex flex-col items-center gap-12 mb-28 md:mb-32">
                        <div className="w-1 h-44 md:h-48 bg-[#0b0b10]/10 flex flex-col items-center overflow-hidden">
                            <motion.div
                    ...
                    <p className="text-3xl md:text-4xl font-institutional italic text-[#0b0b10]/65 mb-48 md:mb-64 max-w-4xl mx-auto leading-tight">
                        "{t.subtitle}"
                    </p>
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="group relative inline-flex max-w-full flex-col items-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-[#5a1f2e] focus-visible:outline-offset-2 active:translate-y-px transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]"
                        onClick={() => window.location.href = "#contact"}
                    >
                        <span className="relative bg-[#0b0b10]/[0.04] border border-[#0b0b10]/10 p-1.5 shadow-premium-2xl">
                        ...
                        <span className="mt-8 flex flex-wrap items-center justify-center gap-4 text-[9px] opacity-60 font-black tracking-widest font-sans text-[#0b0b10]">
                            <span className="t-data tabular-nums" dir="ltr">SOVEREIGN_AUTH_v9.2</span>
                            <span className="w-8 h-px bg-[#0b0b10]/40" />
