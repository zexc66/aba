...
const ACTIVE_ISO_CODES = new Set(["gh","gm","sl","ci","bf","ao","sd","eg","jo","sy","sa"]);

function WorldMapSVGComponent({ className, viewBox, activeIsoCode, hoveredIsoCode, onCountryHover, onCountryClick, children }: WorldMapProps) {
    return (
        
<svg version="1.1" 
     viewBox={viewBox || "340 395 210 180"} 
...
<g>
    <path id="_somaliland" 
                 ...
                 onClick={() => onCountryClick?.("_somaliland")}
                 style={{
                     fill: activeIsoCode === "_somaliland" || hoveredIsoCode === "_somaliland"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "_somaliland" || hoveredIsoCode === "_somaliland"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
                     stroke: false ? "#5a1f2e" : "#cbd5e1",
                     strokeWidth: false ? "0.5px" : "0.2px",
                     strokeOpacity: false ? 0.9 : 0.4,
    ...
    <path id="ae" 
                 onMouseEnter={() => onCountryHover?.("ae")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ae")}
                 style={{
                     fill: activeIsoCode === "ae" || hoveredIsoCode === "ae"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ae" || hoveredIsoCode === "ae"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="af" 
                 onMouseEnter={() => onCountryHover?.("af")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("af")}
                 style={{
                     fill: activeIsoCode === "af" || hoveredIsoCode === "af"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "af" || hoveredIsoCode === "af"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="al" 
                 onMouseEnter={() => onCountryHover?.("al")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("al")}
                 style={{
                     fill: activeIsoCode === "al" || hoveredIsoCode === "al"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "al" || hoveredIsoCode === "al"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="am" 
                 onMouseEnter={() => onCountryHover?.("am")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("am")}
                 style={{
                     fill: activeIsoCode === "am" || hoveredIsoCode === "am"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "am" || hoveredIsoCode === "am"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ao" 
                 onMouseEnter={() => onCountryHover?.("ao")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ao")}
                 style={{
                     fill: activeIsoCode === "ao" || hoveredIsoCode === "ao"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ao" || hoveredIsoCode === "ao"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
                     stroke: true ? "#5a1f2e" : "#cbd5e1",
                     strokeWidth: true ? "0.5px" : "0.2px",
                     strokeOpacity: true ? 0.9 : 0.4,
                     transition: "all 0.3s ease",
    ...
    <g id="ar" 
                 onMouseEnter={() => onCountryHover?.("ar")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ar")}
                 style={{
                     fill: activeIsoCode === "ar" || hoveredIsoCode === "ar"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ar" || hoveredIsoCode === "ar"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="at" 
                 onMouseEnter={() => onCountryHover?.("at")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("at")}
                 style={{
                     fill: activeIsoCode === "at" || hoveredIsoCode === "at"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "at" || hoveredIsoCode === "at"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="au" 
                 onMouseEnter={() => onCountryHover?.("au")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("au")}
                 style={{
                     fill: activeIsoCode === "au" || hoveredIsoCode === "au"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "au" || hoveredIsoCode === "au"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="az" 
                 onMouseEnter={() => onCountryHover?.("az")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("az")}
                 style={{
                     fill: activeIsoCode === "az" || hoveredIsoCode === "az"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "az" || hoveredIsoCode === "az"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ba" 
                 onMouseEnter={() => onCountryHover?.("ba")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ba")}
                 style={{
                     fill: activeIsoCode === "ba" || hoveredIsoCode === "ba"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ba" || hoveredIsoCode === "ba"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bd" 
                 onMouseEnter={() => onCountryHover?.("bd")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bd")}
                 style={{
                     fill: activeIsoCode === "bd" || hoveredIsoCode === "bd"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bd" || hoveredIsoCode === "bd"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="be" 
                 onMouseEnter={() => onCountryHover?.("be")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("be")}
                 style={{
                     fill: activeIsoCode === "be" || hoveredIsoCode === "be"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "be" || hoveredIsoCode === "be"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bf" 
                 onMouseEnter={() => onCountryHover?.("bf")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bf")}
                 style={{
                     fill: activeIsoCode === "bf" || hoveredIsoCode === "bf"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bf" || hoveredIsoCode === "bf"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <path id="bg" 
                 onMouseEnter={() => onCountryHover?.("bg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bg")}
                 style={{
                     fill: activeIsoCode === "bg" || hoveredIsoCode === "bg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bg" || hoveredIsoCode === "bg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bi" 
                 onMouseEnter={() => onCountryHover?.("bi")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bi")}
                 style={{
                     fill: activeIsoCode === "bi" || hoveredIsoCode === "bi"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bi" || hoveredIsoCode === "bi"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bj" 
                 onMouseEnter={() => onCountryHover?.("bj")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bj")}
                 style={{
                     fill: activeIsoCode === "bj" || hoveredIsoCode === "bj"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bj" || hoveredIsoCode === "bj"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bn" 
                 onMouseEnter={() => onCountryHover?.("bn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bn")}
                 style={{
                     fill: activeIsoCode === "bn" || hoveredIsoCode === "bn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bn" || hoveredIsoCode === "bn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bo" 
                 onMouseEnter={() => onCountryHover?.("bo")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bo")}
                 style={{
                     fill: activeIsoCode === "bo" || hoveredIsoCode === "bo"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bo" || hoveredIsoCode === "bo"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="br" 
                 onMouseEnter={() => onCountryHover?.("br")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("br")}
                 style={{
                     fill: activeIsoCode === "br" || hoveredIsoCode === "br"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "br" || hoveredIsoCode === "br"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="bs" 
                 onMouseEnter={() => onCountryHover?.("bs")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bs")}
                 style={{
                     fill: activeIsoCode === "bs" || hoveredIsoCode === "bs"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bs" || hoveredIsoCode === "bs"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bt" 
                 onMouseEnter={() => onCountryHover?.("bt")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bt")}
                 style={{
                     fill: activeIsoCode === "bt" || hoveredIsoCode === "bt"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bt" || hoveredIsoCode === "bt"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bw" 
                 onMouseEnter={() => onCountryHover?.("bw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bw")}
                 style={{
                     fill: activeIsoCode === "bw" || hoveredIsoCode === "bw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bw" || hoveredIsoCode === "bw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="by" 
                 onMouseEnter={() => onCountryHover?.("by")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("by")}
                 style={{
                     fill: activeIsoCode === "by" || hoveredIsoCode === "by"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "by" || hoveredIsoCode === "by"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="bz" 
                 onMouseEnter={() => onCountryHover?.("bz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("bz")}
                 style={{
                     fill: activeIsoCode === "bz" || hoveredIsoCode === "bz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "bz" || hoveredIsoCode === "bz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ca" 
                 onMouseEnter={() => onCountryHover?.("ca")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ca")}
                 style={{
                     fill: activeIsoCode === "ca" || hoveredIsoCode === "ca"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ca" || hoveredIsoCode === "ca"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cd" 
                 onMouseEnter={() => onCountryHover?.("cd")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cd")}
                 style={{
                     fill: activeIsoCode === "cd" || hoveredIsoCode === "cd"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cd" || hoveredIsoCode === "cd"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cf" 
                 onMouseEnter={() => onCountryHover?.("cf")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cf")}
                 style={{
                     fill: activeIsoCode === "cf" || hoveredIsoCode === "cf"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cf" || hoveredIsoCode === "cf"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cg" 
                 onMouseEnter={() => onCountryHover?.("cg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cg")}
                 style={{
                     fill: activeIsoCode === "cg" || hoveredIsoCode === "cg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cg" || hoveredIsoCode === "cg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ch" 
                 onMouseEnter={() => onCountryHover?.("ch")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ch")}
                 style={{
                     fill: activeIsoCode === "ch" || hoveredIsoCode === "ch"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ch" || hoveredIsoCode === "ch"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ci" 
                 onMouseEnter={() => onCountryHover?.("ci")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ci")}
                 style={{
                     fill: activeIsoCode === "ci" || hoveredIsoCode === "ci"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ci" || hoveredIsoCode === "ci"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <g id="cl" 
                 onMouseEnter={() => onCountryHover?.("cl")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cl")}
                 style={{
                     fill: activeIsoCode === "cl" || hoveredIsoCode === "cl"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cl" || hoveredIsoCode === "cl"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cm" 
                 onMouseEnter={() => onCountryHover?.("cm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cm")}
                 style={{
                     fill: activeIsoCode === "cm" || hoveredIsoCode === "cm"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cm" || hoveredIsoCode === "cm"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="cn" 
                 onMouseEnter={() => onCountryHover?.("cn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cn")}
                 style={{
                     fill: activeIsoCode === "cn" || hoveredIsoCode === "cn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cn" || hoveredIsoCode === "cn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="co" 
                 onMouseEnter={() => onCountryHover?.("co")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("co")}
                 style={{
                     fill: activeIsoCode === "co" || hoveredIsoCode === "co"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "co" || hoveredIsoCode === "co"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cr" 
                 onMouseEnter={() => onCountryHover?.("cr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cr")}
                 style={{
                     fill: activeIsoCode === "cr" || hoveredIsoCode === "cr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cr" || hoveredIsoCode === "cr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cu" 
                 onMouseEnter={() => onCountryHover?.("cu")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cu")}
                 style={{
                     fill: activeIsoCode === "cu" || hoveredIsoCode === "cu"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cu" || hoveredIsoCode === "cu"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="cv" 
                 onMouseEnter={() => onCountryHover?.("cv")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cv")}
                 style={{
                     fill: activeIsoCode === "cv" || hoveredIsoCode === "cv"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cv" || hoveredIsoCode === "cv"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cy" 
                 onMouseEnter={() => onCountryHover?.("cy")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cy")}
                 style={{
                     fill: activeIsoCode === "cy" || hoveredIsoCode === "cy"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cy" || hoveredIsoCode === "cy"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="cz" 
                 onMouseEnter={() => onCountryHover?.("cz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("cz")}
                 style={{
                     fill: activeIsoCode === "cz" || hoveredIsoCode === "cz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "cz" || hoveredIsoCode === "cz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="de" 
                 onMouseEnter={() => onCountryHover?.("de")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("de")}
                 style={{
                     fill: activeIsoCode === "de" || hoveredIsoCode === "de"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "de" || hoveredIsoCode === "de"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="dk" 
                 onMouseEnter={() => onCountryHover?.("dk")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("dk")}
                 style={{
                     fill: activeIsoCode === "dk" || hoveredIsoCode === "dk"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "dk" || hoveredIsoCode === "dk"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="dj" 
                 onMouseEnter={() => onCountryHover?.("dj")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("dj")}
                 style={{
                     fill: activeIsoCode === "dj" || hoveredIsoCode === "dj"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "dj" || hoveredIsoCode === "dj"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="dm" 
                 onMouseEnter={() => onCountryHover?.("dm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("dm")}
                 style={{
                     fill: activeIsoCode === "dm" || hoveredIsoCode === "dm"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "dm" || hoveredIsoCode === "dm"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="do" 
                 onMouseEnter={() => onCountryHover?.("do")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("do")}
                 style={{
                     fill: activeIsoCode === "do" || hoveredIsoCode === "do"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "do" || hoveredIsoCode === "do"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="dz" 
                 onMouseEnter={() => onCountryHover?.("dz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("dz")}
                 style={{
                     fill: activeIsoCode === "dz" || hoveredIsoCode === "dz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "dz" || hoveredIsoCode === "dz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ec" 
                 onMouseEnter={() => onCountryHover?.("ec")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ec")}
                 style={{
                     fill: activeIsoCode === "ec" || hoveredIsoCode === "ec"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ec" || hoveredIsoCode === "ec"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ee" 
                 onMouseEnter={() => onCountryHover?.("ee")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ee")}
                 style={{
                     fill: activeIsoCode === "ee" || hoveredIsoCode === "ee"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ee" || hoveredIsoCode === "ee"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="eg" 
                 onMouseEnter={() => onCountryHover?.("eg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("eg")}
                 style={{
                     fill: activeIsoCode === "eg" || hoveredIsoCode === "eg"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "eg" || hoveredIsoCode === "eg"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <path id="er" 
                 onMouseEnter={() => onCountryHover?.("er")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("er")}
                 style={{
                     fill: activeIsoCode === "er" || hoveredIsoCode === "er"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "er" || hoveredIsoCode === "er"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="es" 
                 onMouseEnter={() => onCountryHover?.("es")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("es")}
                 style={{
                     fill: activeIsoCode === "es" || hoveredIsoCode === "es"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "es" || hoveredIsoCode === "es"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="et" 
                 onMouseEnter={() => onCountryHover?.("et")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("et")}
                 style={{
                     fill: activeIsoCode === "et" || hoveredIsoCode === "et"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "et" || hoveredIsoCode === "et"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="fi" 
                 onMouseEnter={() => onCountryHover?.("fi")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("fi")}
                 style={{
                     fill: activeIsoCode === "fi" || hoveredIsoCode === "fi"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "fi" || hoveredIsoCode === "fi"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="fk" 
                 onMouseEnter={() => onCountryHover?.("fk")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("fk")}
                 style={{
                     fill: activeIsoCode === "fk" || hoveredIsoCode === "fk"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "fk" || hoveredIsoCode === "fk"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="fr" 
                 onMouseEnter={() => onCountryHover?.("fr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("fr")}
                 style={{
                     fill: activeIsoCode === "fr" || hoveredIsoCode === "fr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "fr" || hoveredIsoCode === "fr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ga" 
                 onMouseEnter={() => onCountryHover?.("ga")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ga")}
                 style={{
                     fill: activeIsoCode === "ga" || hoveredIsoCode === "ga"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ga" || hoveredIsoCode === "ga"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="gb" 
                 onMouseEnter={() => onCountryHover?.("gb")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gb")}
                 style={{
                     fill: activeIsoCode === "gb" || hoveredIsoCode === "gb"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gb" || hoveredIsoCode === "gb"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ge" 
                 onMouseEnter={() => onCountryHover?.("ge")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ge")}
                 style={{
                     fill: activeIsoCode === "ge" || hoveredIsoCode === "ge"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ge" || hoveredIsoCode === "ge"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="gh" 
                 onMouseEnter={() => onCountryHover?.("gh")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gh")}
                 style={{
                     fill: activeIsoCode === "gh" || hoveredIsoCode === "gh"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gh" || hoveredIsoCode === "gh"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <g id="gl" 
                 onMouseEnter={() => onCountryHover?.("gl")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gl")}
                 style={{
                     fill: activeIsoCode === "gl" || hoveredIsoCode === "gl"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gl" || hoveredIsoCode === "gl"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="gm" 
                 onMouseEnter={() => onCountryHover?.("gm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gm")}
                 style={{
                     fill: activeIsoCode === "gm" || hoveredIsoCode === "gm"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gm" || hoveredIsoCode === "gm"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <path id="gn" 
                 onMouseEnter={() => onCountryHover?.("gn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gn")}
                 style={{
                     fill: activeIsoCode === "gn" || hoveredIsoCode === "gn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gn" || hoveredIsoCode === "gn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="gq" 
                 onMouseEnter={() => onCountryHover?.("gq")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gq")}
                 style={{
                     fill: activeIsoCode === "gq" || hoveredIsoCode === "gq"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gq" || hoveredIsoCode === "gq"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="gr" 
                 onMouseEnter={() => onCountryHover?.("gr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gr")}
                 style={{
                     fill: activeIsoCode === "gr" || hoveredIsoCode === "gr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gr" || hoveredIsoCode === "gr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="gt" 
                 onMouseEnter={() => onCountryHover?.("gt")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gt")}
                 style={{
                     fill: activeIsoCode === "gt" || hoveredIsoCode === "gt"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gt" || hoveredIsoCode === "gt"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="gw" 
                 onMouseEnter={() => onCountryHover?.("gw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gw")}
                 style={{
                     fill: activeIsoCode === "gw" || hoveredIsoCode === "gw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gw" || hoveredIsoCode === "gw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="gy" 
                 onMouseEnter={() => onCountryHover?.("gy")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("gy")}
                 style={{
                     fill: activeIsoCode === "gy" || hoveredIsoCode === "gy"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "gy" || hoveredIsoCode === "gy"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="hn" 
                 onMouseEnter={() => onCountryHover?.("hn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("hn")}
                 style={{
                     fill: activeIsoCode === "hn" || hoveredIsoCode === "hn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "hn" || hoveredIsoCode === "hn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="hr" 
                 onMouseEnter={() => onCountryHover?.("hr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("hr")}
                 style={{
                     fill: activeIsoCode === "hr" || hoveredIsoCode === "hr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "hr" || hoveredIsoCode === "hr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ht" 
                 onMouseEnter={() => onCountryHover?.("ht")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ht")}
                 style={{
                     fill: activeIsoCode === "ht" || hoveredIsoCode === "ht"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ht" || hoveredIsoCode === "ht"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="hu" 
                 onMouseEnter={() => onCountryHover?.("hu")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("hu")}
                 style={{
                     fill: activeIsoCode === "hu" || hoveredIsoCode === "hu"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "hu" || hoveredIsoCode === "hu"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="id" 
                 onMouseEnter={() => onCountryHover?.("id")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("id")}
                 style={{
                     fill: activeIsoCode === "id" || hoveredIsoCode === "id"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "id" || hoveredIsoCode === "id"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ie" 
                 onMouseEnter={() => onCountryHover?.("ie")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ie")}
                 style={{
                     fill: activeIsoCode === "ie" || hoveredIsoCode === "ie"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ie" || hoveredIsoCode === "ie"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="il" 
                 onMouseEnter={() => onCountryHover?.("il")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("il")}
                 style={{
                     fill: activeIsoCode === "il" || hoveredIsoCode === "il"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "il" || hoveredIsoCode === "il"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="in" 
                 onMouseEnter={() => onCountryHover?.("in")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("in")}
                 style={{
                     fill: activeIsoCode === "in" || hoveredIsoCode === "in"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "in" || hoveredIsoCode === "in"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="iq" 
                 onMouseEnter={() => onCountryHover?.("iq")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("iq")}
                 style={{
                     fill: activeIsoCode === "iq" || hoveredIsoCode === "iq"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "iq" || hoveredIsoCode === "iq"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ir" 
                 onMouseEnter={() => onCountryHover?.("ir")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ir")}
                 style={{
                     fill: activeIsoCode === "ir" || hoveredIsoCode === "ir"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ir" || hoveredIsoCode === "ir"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="is" 
                 onMouseEnter={() => onCountryHover?.("is")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("is")}
                 style={{
                     fill: activeIsoCode === "is" || hoveredIsoCode === "is"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "is" || hoveredIsoCode === "is"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="it" 
                 onMouseEnter={() => onCountryHover?.("it")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("it")}
                 style={{
                     fill: activeIsoCode === "it" || hoveredIsoCode === "it"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "it" || hoveredIsoCode === "it"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="jm" 
                 onMouseEnter={() => onCountryHover?.("jm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("jm")}
                 style={{
                     fill: activeIsoCode === "jm" || hoveredIsoCode === "jm"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "jm" || hoveredIsoCode === "jm"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="jo" 
                 onMouseEnter={() => onCountryHover?.("jo")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("jo")}
                 style={{
                     fill: activeIsoCode === "jo" || hoveredIsoCode === "jo"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "jo" || hoveredIsoCode === "jo"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <g id="jp" 
                 onMouseEnter={() => onCountryHover?.("jp")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("jp")}
                 style={{
                     fill: activeIsoCode === "jp" || hoveredIsoCode === "jp"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "jp" || hoveredIsoCode === "jp"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ke" 
                 onMouseEnter={() => onCountryHover?.("ke")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ke")}
                 style={{
                     fill: activeIsoCode === "ke" || hoveredIsoCode === "ke"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ke" || hoveredIsoCode === "ke"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="kg" 
                 onMouseEnter={() => onCountryHover?.("kg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("kg")}
                 style={{
                     fill: activeIsoCode === "kg" || hoveredIsoCode === "kg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "kg" || hoveredIsoCode === "kg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="kh" 
                 onMouseEnter={() => onCountryHover?.("kh")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("kh")}
                 style={{
                     fill: activeIsoCode === "kh" || hoveredIsoCode === "kh"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "kh" || hoveredIsoCode === "kh"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="km" 
                 onMouseEnter={() => onCountryHover?.("km")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("km")}
                 style={{
                     fill: activeIsoCode === "km" || hoveredIsoCode === "km"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "km" || hoveredIsoCode === "km"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="kp" 
                 onMouseEnter={() => onCountryHover?.("kp")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("kp")}
                 style={{
                     fill: activeIsoCode === "kp" || hoveredIsoCode === "kp"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "kp" || hoveredIsoCode === "kp"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="kr" 
                 onMouseEnter={() => onCountryHover?.("kr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("kr")}
                 style={{
                     fill: activeIsoCode === "kr" || hoveredIsoCode === "kr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "kr" || hoveredIsoCode === "kr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="kw" 
                 onMouseEnter={() => onCountryHover?.("kw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("kw")}
                 style={{
                     fill: activeIsoCode === "kw" || hoveredIsoCode === "kw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "kw" || hoveredIsoCode === "kw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="kz" 
                 onMouseEnter={() => onCountryHover?.("kz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("kz")}
                 style={{
                     fill: activeIsoCode === "kz" || hoveredIsoCode === "kz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "kz" || hoveredIsoCode === "kz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="la" 
                 onMouseEnter={() => onCountryHover?.("la")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("la")}
                 style={{
                     fill: activeIsoCode === "la" || hoveredIsoCode === "la"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "la" || hoveredIsoCode === "la"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lb" 
                 onMouseEnter={() => onCountryHover?.("lb")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lb")}
                 style={{
                     fill: activeIsoCode === "lb" || hoveredIsoCode === "lb"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lb" || hoveredIsoCode === "lb"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lc" 
                 onMouseEnter={() => onCountryHover?.("lc")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lc")}
                 style={{
                     fill: activeIsoCode === "lc" || hoveredIsoCode === "lc"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lc" || hoveredIsoCode === "lc"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lk" 
                 onMouseEnter={() => onCountryHover?.("lk")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lk")}
                 style={{
                     fill: activeIsoCode === "lk" || hoveredIsoCode === "lk"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lk" || hoveredIsoCode === "lk"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lr" 
                 onMouseEnter={() => onCountryHover?.("lr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lr")}
                 style={{
                     fill: activeIsoCode === "lr" || hoveredIsoCode === "lr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lr" || hoveredIsoCode === "lr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ls" 
                 onMouseEnter={() => onCountryHover?.("ls")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ls")}
                 style={{
                     fill: activeIsoCode === "ls" || hoveredIsoCode === "ls"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ls" || hoveredIsoCode === "ls"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lt" 
                 onMouseEnter={() => onCountryHover?.("lt")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lt")}
                 style={{
                     fill: activeIsoCode === "lt" || hoveredIsoCode === "lt"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lt" || hoveredIsoCode === "lt"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lu" 
                 onMouseEnter={() => onCountryHover?.("lu")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lu")}
                 style={{
                     fill: activeIsoCode === "lu" || hoveredIsoCode === "lu"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lu" || hoveredIsoCode === "lu"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="lv" 
                 onMouseEnter={() => onCountryHover?.("lv")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("lv")}
                 style={{
                     fill: activeIsoCode === "lv" || hoveredIsoCode === "lv"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "lv" || hoveredIsoCode === "lv"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ly" 
                 onMouseEnter={() => onCountryHover?.("ly")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ly")}
                 style={{
                     fill: activeIsoCode === "ly" || hoveredIsoCode === "ly"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ly" || hoveredIsoCode === "ly"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ma" 
                 onMouseEnter={() => onCountryHover?.("ma")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ma")}
                 style={{
                     fill: activeIsoCode === "ma" || hoveredIsoCode === "ma"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ma" || hoveredIsoCode === "ma"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="md" 
                 onMouseEnter={() => onCountryHover?.("md")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("md")}
                 style={{
                     fill: activeIsoCode === "md" || hoveredIsoCode === "md"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "md" || hoveredIsoCode === "md"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="me" 
                 onMouseEnter={() => onCountryHover?.("me")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("me")}
                 style={{
                     fill: activeIsoCode === "me" || hoveredIsoCode === "me"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "me" || hoveredIsoCode === "me"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mg" 
                 onMouseEnter={() => onCountryHover?.("mg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mg")}
                 style={{
                     fill: activeIsoCode === "mg" || hoveredIsoCode === "mg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mg" || hoveredIsoCode === "mg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mk" 
                 onMouseEnter={() => onCountryHover?.("mk")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mk")}
                 style={{
                     fill: activeIsoCode === "mk" || hoveredIsoCode === "mk"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mk" || hoveredIsoCode === "mk"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ml" 
                 onMouseEnter={() => onCountryHover?.("ml")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ml")}
                 style={{
                     fill: activeIsoCode === "ml" || hoveredIsoCode === "ml"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ml" || hoveredIsoCode === "ml"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mm" 
                 onMouseEnter={() => onCountryHover?.("mm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mm")}
                 style={{
                     fill: activeIsoCode === "mm" || hoveredIsoCode === "mm"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mm" || hoveredIsoCode === "mm"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mn" 
                 onMouseEnter={() => onCountryHover?.("mn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mn")}
                 style={{
                     fill: activeIsoCode === "mn" || hoveredIsoCode === "mn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mn" || hoveredIsoCode === "mn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mr" 
                 onMouseEnter={() => onCountryHover?.("mr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mr")}
                 style={{
                     fill: activeIsoCode === "mr" || hoveredIsoCode === "mr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mr" || hoveredIsoCode === "mr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mt" 
                 onMouseEnter={() => onCountryHover?.("mt")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mt")}
                 style={{
                     fill: activeIsoCode === "mt" || hoveredIsoCode === "mt"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mt" || hoveredIsoCode === "mt"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mu" 
                 onMouseEnter={() => onCountryHover?.("mu")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mu")}
                 style={{
                     fill: activeIsoCode === "mu" || hoveredIsoCode === "mu"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mu" || hoveredIsoCode === "mu"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="mv" 
                 onMouseEnter={() => onCountryHover?.("mv")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mv")}
                 style={{
                     fill: activeIsoCode === "mv" || hoveredIsoCode === "mv"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mv" || hoveredIsoCode === "mv"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mw" 
                 onMouseEnter={() => onCountryHover?.("mw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mw")}
                 style={{
                     fill: activeIsoCode === "mw" || hoveredIsoCode === "mw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mw" || hoveredIsoCode === "mw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mx" 
                 onMouseEnter={() => onCountryHover?.("mx")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mx")}
                 style={{
                     fill: activeIsoCode === "mx" || hoveredIsoCode === "mx"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mx" || hoveredIsoCode === "mx"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="my" 
                 onMouseEnter={() => onCountryHover?.("my")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("my")}
                 style={{
                     fill: activeIsoCode === "my" || hoveredIsoCode === "my"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "my" || hoveredIsoCode === "my"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="mz" 
                 onMouseEnter={() => onCountryHover?.("mz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("mz")}
                 style={{
                     fill: activeIsoCode === "mz" || hoveredIsoCode === "mz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "mz" || hoveredIsoCode === "mz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="na" 
                 onMouseEnter={() => onCountryHover?.("na")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("na")}
                 style={{
                     fill: activeIsoCode === "na" || hoveredIsoCode === "na"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "na" || hoveredIsoCode === "na"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="nc" 
                 onMouseEnter={() => onCountryHover?.("nc")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("nc")}
                 style={{
                     fill: activeIsoCode === "nc" || hoveredIsoCode === "nc"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "nc" || hoveredIsoCode === "nc"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ne" 
                 onMouseEnter={() => onCountryHover?.("ne")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ne")}
                 style={{
                     fill: activeIsoCode === "ne" || hoveredIsoCode === "ne"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ne" || hoveredIsoCode === "ne"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ng" 
                 onMouseEnter={() => onCountryHover?.("ng")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ng")}
                 style={{
                     fill: activeIsoCode === "ng" || hoveredIsoCode === "ng"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ng" || hoveredIsoCode === "ng"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ni" 
                 onMouseEnter={() => onCountryHover?.("ni")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ni")}
                 style={{
                     fill: activeIsoCode === "ni" || hoveredIsoCode === "ni"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ni" || hoveredIsoCode === "ni"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="nl" 
                 onMouseEnter={() => onCountryHover?.("nl")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("nl")}
                 style={{
                     fill: activeIsoCode === "nl" || hoveredIsoCode === "nl"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "nl" || hoveredIsoCode === "nl"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="no" 
                 onMouseEnter={() => onCountryHover?.("no")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("no")}
                 style={{
                     fill: activeIsoCode === "no" || hoveredIsoCode === "no"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "no" || hoveredIsoCode === "no"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="np" 
                 onMouseEnter={() => onCountryHover?.("np")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("np")}
                 style={{
                     fill: activeIsoCode === "np" || hoveredIsoCode === "np"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "np" || hoveredIsoCode === "np"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="nz" 
                 onMouseEnter={() => onCountryHover?.("nz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("nz")}
                 style={{
                     fill: activeIsoCode === "nz" || hoveredIsoCode === "nz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "nz" || hoveredIsoCode === "nz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="om" 
                 onMouseEnter={() => onCountryHover?.("om")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("om")}
                 style={{
                     fill: activeIsoCode === "om" || hoveredIsoCode === "om"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "om" || hoveredIsoCode === "om"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="pa" 
                 onMouseEnter={() => onCountryHover?.("pa")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pa")}
                 style={{
                     fill: activeIsoCode === "pa" || hoveredIsoCode === "pa"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pa" || hoveredIsoCode === "pa"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="pe" 
                 onMouseEnter={() => onCountryHover?.("pe")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pe")}
                 style={{
                     fill: activeIsoCode === "pe" || hoveredIsoCode === "pe"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pe" || hoveredIsoCode === "pe"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="pg" 
                 onMouseEnter={() => onCountryHover?.("pg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pg")}
                 style={{
                     fill: activeIsoCode === "pg" || hoveredIsoCode === "pg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pg" || hoveredIsoCode === "pg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ph" 
                 onMouseEnter={() => onCountryHover?.("ph")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ph")}
                 style={{
                     fill: activeIsoCode === "ph" || hoveredIsoCode === "ph"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ph" || hoveredIsoCode === "ph"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="pk" 
                 onMouseEnter={() => onCountryHover?.("pk")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pk")}
                 style={{
                     fill: activeIsoCode === "pk" || hoveredIsoCode === "pk"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pk" || hoveredIsoCode === "pk"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="pl" 
                 onMouseEnter={() => onCountryHover?.("pl")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pl")}
                 style={{
                     fill: activeIsoCode === "pl" || hoveredIsoCode === "pl"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pl" || hoveredIsoCode === "pl"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="pr" 
                 onMouseEnter={() => onCountryHover?.("pr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pr")}
                 style={{
                     fill: activeIsoCode === "pr" || hoveredIsoCode === "pr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pr" || hoveredIsoCode === "pr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="pt" 
                 onMouseEnter={() => onCountryHover?.("pt")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("pt")}
                 style={{
                     fill: activeIsoCode === "pt" || hoveredIsoCode === "pt"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "pt" || hoveredIsoCode === "pt"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="py" 
                 onMouseEnter={() => onCountryHover?.("py")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("py")}
                 style={{
                     fill: activeIsoCode === "py" || hoveredIsoCode === "py"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "py" || hoveredIsoCode === "py"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="qa" 
                 onMouseEnter={() => onCountryHover?.("qa")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("qa")}
                 style={{
                     fill: activeIsoCode === "qa" || hoveredIsoCode === "qa"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "qa" || hoveredIsoCode === "qa"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ro" 
                 onMouseEnter={() => onCountryHover?.("ro")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ro")}
                 style={{
                     fill: activeIsoCode === "ro" || hoveredIsoCode === "ro"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ro" || hoveredIsoCode === "ro"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="rs" 
                 onMouseEnter={() => onCountryHover?.("rs")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("rs")}
                 style={{
                     fill: activeIsoCode === "rs" || hoveredIsoCode === "rs"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "rs" || hoveredIsoCode === "rs"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ru" 
                 onMouseEnter={() => onCountryHover?.("ru")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ru")}
                 style={{
                     fill: activeIsoCode === "ru" || hoveredIsoCode === "ru"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ru" || hoveredIsoCode === "ru"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="rw" 
                 onMouseEnter={() => onCountryHover?.("rw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("rw")}
                 style={{
                     fill: activeIsoCode === "rw" || hoveredIsoCode === "rw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "rw" || hoveredIsoCode === "rw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sa" 
                 onMouseEnter={() => onCountryHover?.("sa")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sa")}
                 style={{
                     fill: activeIsoCode === "sa" || hoveredIsoCode === "sa"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sa" || hoveredIsoCode === "sa"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <g id="sb" 
                 onMouseEnter={() => onCountryHover?.("sb")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sb")}
                 style={{
                     fill: activeIsoCode === "sb" || hoveredIsoCode === "sb"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sb" || hoveredIsoCode === "sb"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="sc" 
                 onMouseEnter={() => onCountryHover?.("sc")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sc")}
                 style={{
                     fill: activeIsoCode === "sc" || hoveredIsoCode === "sc"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sc" || hoveredIsoCode === "sc"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sd" 
                 onMouseEnter={() => onCountryHover?.("sd")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sd")}
                 style={{
                     fill: activeIsoCode === "sd" || hoveredIsoCode === "sd"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sd" || hoveredIsoCode === "sd"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <g id="se" 
                 onMouseEnter={() => onCountryHover?.("se")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("se")}
                 style={{
                     fill: activeIsoCode === "se" || hoveredIsoCode === "se"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "se" || hoveredIsoCode === "se"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sg" 
                 onMouseEnter={() => onCountryHover?.("sg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sg")}
                 style={{
                     fill: activeIsoCode === "sg" || hoveredIsoCode === "sg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sg" || hoveredIsoCode === "sg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="si" 
                 onMouseEnter={() => onCountryHover?.("si")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("si")}
                 style={{
                     fill: activeIsoCode === "si" || hoveredIsoCode === "si"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "si" || hoveredIsoCode === "si"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sk" 
                 onMouseEnter={() => onCountryHover?.("sk")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sk")}
                 style={{
                     fill: activeIsoCode === "sk" || hoveredIsoCode === "sk"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sk" || hoveredIsoCode === "sk"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sl" 
                 onMouseEnter={() => onCountryHover?.("sl")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sl")}
                 style={{
                     fill: activeIsoCode === "sl" || hoveredIsoCode === "sl"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sl" || hoveredIsoCode === "sl"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <path id="sn" 
                 onMouseEnter={() => onCountryHover?.("sn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sn")}
                 style={{
                     fill: activeIsoCode === "sn" || hoveredIsoCode === "sn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sn" || hoveredIsoCode === "sn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="so" 
                 onMouseEnter={() => onCountryHover?.("so")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("so")}
                 style={{
                     fill: activeIsoCode === "so" || hoveredIsoCode === "so"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "so" || hoveredIsoCode === "so"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sr" 
                 onMouseEnter={() => onCountryHover?.("sr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sr")}
                 style={{
                     fill: activeIsoCode === "sr" || hoveredIsoCode === "sr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sr" || hoveredIsoCode === "sr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ss" 
                 onMouseEnter={() => onCountryHover?.("ss")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ss")}
                 style={{
                     fill: activeIsoCode === "ss" || hoveredIsoCode === "ss"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ss" || hoveredIsoCode === "ss"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="st" 
                 onMouseEnter={() => onCountryHover?.("st")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("st")}
                 style={{
                     fill: activeIsoCode === "st" || hoveredIsoCode === "st"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "st" || hoveredIsoCode === "st"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sv" 
                 onMouseEnter={() => onCountryHover?.("sv")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sv")}
                 style={{
                     fill: activeIsoCode === "sv" || hoveredIsoCode === "sv"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sv" || hoveredIsoCode === "sv"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="sy" 
                 onMouseEnter={() => onCountryHover?.("sy")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sy")}
                 style={{
                     fill: activeIsoCode === "sy" || hoveredIsoCode === "sy"
                         ? "#5a1f2e"
                         : true
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sy" || hoveredIsoCode === "sy"
                         ? 0.95
                         : true
                         ? 0.50
                         : 0.15,
    ...
    <path id="sz" 
                 onMouseEnter={() => onCountryHover?.("sz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("sz")}
                 style={{
                     fill: activeIsoCode === "sz" || hoveredIsoCode === "sz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "sz" || hoveredIsoCode === "sz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="td" 
                 onMouseEnter={() => onCountryHover?.("td")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("td")}
                 style={{
                     fill: activeIsoCode === "td" || hoveredIsoCode === "td"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "td" || hoveredIsoCode === "td"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tg" 
                 onMouseEnter={() => onCountryHover?.("tg")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tg")}
                 style={{
                     fill: activeIsoCode === "tg" || hoveredIsoCode === "tg"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tg" || hoveredIsoCode === "tg"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="th" 
                 onMouseEnter={() => onCountryHover?.("th")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("th")}
                 style={{
                     fill: activeIsoCode === "th" || hoveredIsoCode === "th"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "th" || hoveredIsoCode === "th"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tj" 
                 onMouseEnter={() => onCountryHover?.("tj")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tj")}
                 style={{
                     fill: activeIsoCode === "tj" || hoveredIsoCode === "tj"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tj" || hoveredIsoCode === "tj"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tm" 
                 onMouseEnter={() => onCountryHover?.("tm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tm")}
                 style={{
                     fill: activeIsoCode === "tm" || hoveredIsoCode === "tm"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tm" || hoveredIsoCode === "tm"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tn" 
                 onMouseEnter={() => onCountryHover?.("tn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tn")}
                 style={{
                     fill: activeIsoCode === "tn" || hoveredIsoCode === "tn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tn" || hoveredIsoCode === "tn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tr" 
                 onMouseEnter={() => onCountryHover?.("tr")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tr")}
                 style={{
                     fill: activeIsoCode === "tr" || hoveredIsoCode === "tr"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tr" || hoveredIsoCode === "tr"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tt" 
                 onMouseEnter={() => onCountryHover?.("tt")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tt")}
                 style={{
                     fill: activeIsoCode === "tt" || hoveredIsoCode === "tt"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tt" || hoveredIsoCode === "tt"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tw" 
                 onMouseEnter={() => onCountryHover?.("tw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tw")}
                 style={{
                     fill: activeIsoCode === "tw" || hoveredIsoCode === "tw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tw" || hoveredIsoCode === "tw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="tz" 
                 onMouseEnter={() => onCountryHover?.("tz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("tz")}
                 style={{
                     fill: activeIsoCode === "tz" || hoveredIsoCode === "tz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "tz" || hoveredIsoCode === "tz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ua" 
                 onMouseEnter={() => onCountryHover?.("ua")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ua")}
                 style={{
                     fill: activeIsoCode === "ua" || hoveredIsoCode === "ua"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ua" || hoveredIsoCode === "ua"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ug" 
                 onMouseEnter={() => onCountryHover?.("ug")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ug")}
                 style={{
                     fill: activeIsoCode === "ug" || hoveredIsoCode === "ug"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ug" || hoveredIsoCode === "ug"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="us" 
                 onMouseEnter={() => onCountryHover?.("us")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("us")}
                 style={{
                     fill: activeIsoCode === "us" || hoveredIsoCode === "us"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "us" || hoveredIsoCode === "us"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="uy" 
                 onMouseEnter={() => onCountryHover?.("uy")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("uy")}
                 style={{
                     fill: activeIsoCode === "uy" || hoveredIsoCode === "uy"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "uy" || hoveredIsoCode === "uy"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="uz" 
                 onMouseEnter={() => onCountryHover?.("uz")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("uz")}
                 style={{
                     fill: activeIsoCode === "uz" || hoveredIsoCode === "uz"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "uz" || hoveredIsoCode === "uz"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="vc" 
                 onMouseEnter={() => onCountryHover?.("vc")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("vc")}
                 style={{
                     fill: activeIsoCode === "vc" || hoveredIsoCode === "vc"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "vc" || hoveredIsoCode === "vc"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="ve" 
                 onMouseEnter={() => onCountryHover?.("ve")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ve")}
                 style={{
                     fill: activeIsoCode === "ve" || hoveredIsoCode === "ve"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ve" || hoveredIsoCode === "ve"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="vn" 
                 onMouseEnter={() => onCountryHover?.("vn")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("vn")}
                 style={{
                     fill: activeIsoCode === "vn" || hoveredIsoCode === "vn"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "vn" || hoveredIsoCode === "vn"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="vu" 
                 onMouseEnter={() => onCountryHover?.("vu")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("vu")}
                 style={{
                     fill: activeIsoCode === "vu" || hoveredIsoCode === "vu"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "vu" || hoveredIsoCode === "vu"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <g id="ye" 
                 onMouseEnter={() => onCountryHover?.("ye")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("ye")}
                 style={{
                     fill: activeIsoCode === "ye" || hoveredIsoCode === "ye"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "ye" || hoveredIsoCode === "ye"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="za" 
                 onMouseEnter={() => onCountryHover?.("za")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("za")}
                 style={{
                     fill: activeIsoCode === "za" || hoveredIsoCode === "za"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "za" || hoveredIsoCode === "za"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="zm" 
                 onMouseEnter={() => onCountryHover?.("zm")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("zm")}
                 style={{
                     fill: activeIsoCode === "zm" || hoveredIsoCode === "zm"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "zm" || hoveredIsoCode === "zm"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
    ...
    <path id="zw" 
                 onMouseEnter={() => onCountryHover?.("zw")} 
                 onMouseLeave={() => onCountryHover?.(null)} 
                 onClick={() => onCountryClick?.("zw")}
                 style={{
                     fill: activeIsoCode === "zw" || hoveredIsoCode === "zw"
                         ? "#5a1f2e"
                         : false
                         ? "#5a1f2e"
                         : "#e5e7eb",
                     fillOpacity: activeIsoCode === "zw" || hoveredIsoCode === "zw"
                         ? 0.95
                         : false
                         ? 0.50
                         : 0.15,
